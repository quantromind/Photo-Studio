...
const { createOrder, getOrders, getOrder, updateOrderStatus, getOrderStats, getRevenueStats, getRevenueExport, deleteOrder, updateBilling, cancelOrder, getPartyHistory } = require('../controllers/orderController');
...
router.get('/party-history/:partyId', auth, roleGuard('studioadmin', 'staff'), getPartyHistory);
